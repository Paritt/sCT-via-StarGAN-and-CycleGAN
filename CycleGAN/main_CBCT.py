...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/Data/CBCT_CycleGAN/train')
    parser.add_argument('--val_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/Data/CBCT_CycleGAN/validation')
    parser.add_argument('--test_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/Data/CBCT_CycleGAN/test/proceeding')
    ...
    parser.add_argument('--result_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/My_CycleGAN/{new_name}/results')
    parser.add_argument('--val_result_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/My_CycleGAN/{new_name}/val')
    parser.add_argument('--report_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/My_CycleGAN/{new_name}/report')
